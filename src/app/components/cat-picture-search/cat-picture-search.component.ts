...
@Component({
  selector: 'cat-picture-search',
  templateUrl: './cat-picture-search.component.html',
  styleUrls: ['./cat-picture-search.component.css']
})
export class CatPictureSearchComponent implements OnInit {
